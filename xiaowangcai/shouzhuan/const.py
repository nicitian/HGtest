...
Const = {
    ...
    'model.order.status.step10': 108, # 高级任务 -千人千面已第一步已完成  下一步是107
    # 流量订单
    ...
    'max.receive.ordersperday': 2,
    'max.receive.ordersperweek': 5,
    ...
    # 商家支付
    'payment.commision.flow': Decimal('0.55'),  # 流量单
    'payment.commision.collect': Decimal('1.1'),  # 收藏单
    ...
    'payment.commision.qian.base': Decimal('4.0'),   # 千人千面任务初始佣金
    ...
    'gain.commision.flow': Decimal('0.33'),  # 流量单
    'gain.commision.collect': Decimal('0.66'),  # 收藏单
    'gain.commision.direct': Decimal('0.21'),  # 直通车单
    'gain.commision.base.deep': Decimal('0.6'),  # 隔天任务初始佣金
    'gain.commision.deep.step': Decimal('0.3'),  # 隔天任务 增长佣金

    'gain.commision.bonus.buyer.ratio': Decimal('0.6'),  # 加赏佣金刷手获得比例
    'gain.commision.bonus.plat.ratio': Decimal('0.4'),  # 加赏佣金平台获得比例
    # 平台盈利
...
tb_level_constraint = (
    (Const['tb.level.sanxing'], 'tb.level.sanxing'),
    (Const['tb.level.siwuxing'], 'tb.level.siwuxing'),
    (Const['tb.level.yizuan'], 'tb.level.yizuan'),
    (Const['tb.level.erzuan'], 'tb.level.erzuan'),
    (Const['tb.level.sanzuan'], 'tb.level.sanzuan'),
    (Const['tb.level.sizuan'], 'tb.level.sizuan'),
)
