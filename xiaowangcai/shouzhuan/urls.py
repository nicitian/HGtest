...
from shouzhuan.views import generic, generic_2, generic_web, generic_web_2
import views
from others import views as others_views

reload(sys)
sys.setdefaultencoding('utf-8')

urlpatterns = [
    # url(r'test', 'management.views.test'),
    url(r'movepic', 'shouzhuan.views.move_pic'),
    url(r'make_tasks_appeal_txt', 'shouzhuan.views.make_tasks_appeal_txt'),
    url(r'change_tasks_appeal_db', 'shouzhuan.views.change_tasks_appeal_db'),

    url(r'make_tasks_order_txt', 'shouzhuan.views.make_tasks_order_txt'),
    url(r'change_tasks_order_db', 'shouzhuan.views.change_tasks_order_db'),

    url(r'make_tasks_task_txt', 'shouzhuan.views.make_tasks_task_txt'),
    url(r'change_tasks_task_db', 'shouzhuan.views.change_tasks_task_db'),

    url(r'make_user_tbaccount_txt', 'shouzhuan.views.make_user_tbaccount_txt'),
    url(r'change_user_tbaccount_db', 'shouzhuan.views.change_user_tbaccount_db'),

    url(r'make_user_user_txt', 'shouzhuan.views.make_user_user_txt'),
    url(r'change_user_user_db', 'shouzhuan.views.change_user_user_db'),
    # url(r'test', 'shouzhuan.views.test'),
    ...
    url(r'^modify_tb_acc', views.modify_tb_acc),
    url(r'others/tk_edit', others_views.tk_edit),

    url(r'mb_tkgoods', others_views.mb_tkgoods, name='mbtkgoods'),
    url(r'tkgoods_list', others_views.tkgoods_list),
