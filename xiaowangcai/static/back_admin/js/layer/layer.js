    ...
    $(config.move).on('mousedown', function(M){    
        ...
        if($(this).attr('move') === 'ok'){
            ...
            if(!$('#layui-layer-moves')[0]){
                $('body').append('<div id="layui-layer-moves" class="layui-layer-moves" style="left:'+ xx +'px; top:'+ yy +'px; width:'+ ww +'px; height:'+ hh +'px; z-index:9999"></div>');
            }
...
'function' === typeof define && define('layer',[],function(){
    ready.run();
    return layer;
});
(function(){
